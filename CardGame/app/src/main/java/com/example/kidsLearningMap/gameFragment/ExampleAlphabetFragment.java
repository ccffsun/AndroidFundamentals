 ...
 */
public class ExampleAlphabetFragment extends Fragment {

    MediaPlayer mediaPlayer;
    public ExampleAlphabetFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_example_alphabet, container, false);
    }
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                //以下独有
                controller.navigate(R.id.action_exampleAlphabetFragment_to_questionAlphabetFragment);
            }
        });

        mediaPlayer = MediaPlayer.create(getContext(),R.raw.alph_exam_apple);
