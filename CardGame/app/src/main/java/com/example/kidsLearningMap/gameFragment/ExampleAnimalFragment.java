 ...
 */
public class ExampleAnimalFragment extends Fragment {

    MediaPlayer mediaPlayer;
    public ExampleAnimalFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_example_animal, container, false);
    }
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                controller.navigate(R.id.action_exampleAnimalFragment_to_questionAnimalFragment);
            }
        });

        mediaPlayer = MediaPlayer.create(getContext(),R.raw.animal_sound_panda);
