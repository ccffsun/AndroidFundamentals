 ...
 */
public class ExampleShapeFragment extends Fragment {

    MediaPlayer mediaPlayer;
    public ExampleShapeFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_example_shape, container, false);
    }
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                controller.navigate(R.id.action_exampleShapeFragment_to_questionShapeFragment2);
            }
        });

        mediaPlayer = MediaPlayer.create(getContext(),R.raw.shape_sound_circle);
